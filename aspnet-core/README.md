...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d4df018b-5d85-44f8-a73b-2ba381f2d269
```

> `d4df018b-5d85-44f8-a73b-2ba381f2d269` is the password of the certificate, you can change it to any password you want.
